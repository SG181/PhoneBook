...
class AddPeople(Toplevel):
    def __init__(self):
        ...
        self.top = Frame(self, height=150, bg='#d1d0ce')
        self.top.pack(fill=X)

        self.bottom = Frame(self, height=500, bg='#c3b1e1')
        self.bottom.pack(fill=X)
        # top frame design
        self.top_image = PhotoImage(file='people.png')
        self.top_image = self.top_image.subsample(5, 5)
        self.top_image_label = Label(self.top, image=self.top_image, bg='#d1d0ce')
        self.top_image_label.place(x=80, y=20)
        self.heading = Label(self.top, text='Add New People', font='ariel 15 bold', bg='#d1d0ce', fg='#333333')
